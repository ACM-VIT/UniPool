          ...
          <View style={styles.statsCard}>
            <Text style={styles.statsValue}>
              {calculatedStats.completedTrips > 0
                ? calculatedStats.completedTrips
          ...
          <View style={styles.statsCard}>
            <Text style={styles.statsValue}>
              {calculatedStats.totalDistance > 0
                ? calculatedStats.totalDistance
                : userData.distance_travelled ?? 0}
              <Text style={styles.statsUnit}> km</Text>
            </Text>
            <Text style={styles.statsLabel}>Travelled</Text>
          </View>

          <View style={styles.statsCard}>
            <Text style={styles.statsValue}>
              {calculatedStats.co2Saved > 0
                ? calculatedStats.co2Saved
                : userData.weight_saved ?? 0}
              <Text style={styles.statsUnit}> kg</Text>
            </Text>
            <Text style={styles.statsLabel}>Carbon Saving</Text>
          </View>
        </View>
