...
import { dummy_upcoming_rides, RideData } from '../dummy-data/DummyUpcomingRides';
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.subHeader}>
                ...
                <Text style={styles.ridesCountText}>{dummy_upcoming_rides.length} rides available</Text>
            ...
            <ScrollView style={styles.ridesList} showsVerticalScrollIndicator={false}>
                {dummy_upcoming_rides.map((ride) => (
                    <RideCard
                        ...
                        seatsAvailable={ride.booked_seats.toString() + "/" + ride.total_seats.toString()}
