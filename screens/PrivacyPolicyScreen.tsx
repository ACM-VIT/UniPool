  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={[styles.contentContainer, tabletScrollContentStyle]}>
        ...
        <Text style={[styles.subSectionTitle, { color: colors.textPrimary }]}>Location Data</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.textPrimary }]}>4. Information Sharing</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.textPrimary }]}>5. Data Security</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.textPrimary }]}>6. Your Rights</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.textPrimary }]}>9. Changes to This Policy</Text>
        <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
