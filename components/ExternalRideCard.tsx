...
import ExternalContactSheet from "./ExternalContactSheet";
...
const ExternalRideCard: React.FC<Props> = ({ ride, authReturnTo }) => {
    ...
    <View style={[styles.card, { backgroundColor: cardBg, borderColor: colors.inkSoft }]}>
      ...
      <View style={styles.bottomRow}>
        ...
        <PressableScale
          ...
          haptic="medium"
        >
          <Text style={[styles.callButtonText, { color: colors.mode === "dark" ? colors.textOnAccent : colors.textOnDark }]}>Contact</Text>
        </PressableScale>
      </View>

      <ExternalContactSheet
        visible={contactOpen}
