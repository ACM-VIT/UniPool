// Country list for the phone-number picker. ISO 3166-1 alpha-2 +
// E.164 dial code, sorted alphabetically by display name. We keep
// the source compact (no flag chars in the file) and derive flag
// emojis at runtime from the alpha-2 code via regional-indicator
// codepoints — works without bundling an image set.
...
/**
 * Derive the flag emoji for an ISO-2 country code. Two regional-
 * indicator symbols (A–Z mapped to U+1F1E6–U+1F1FF) combine into a
 * single grapheme cluster that platforms render as the flag.
 */
...
export const COUNTRIES: Country[] = [
  ...
  { code: "TC", name: "Turks & Caicos Islands", dial: "1649" },
  ...
  { code: "WF", name: "Wallis & Futuna", dial: "681" },
...
/**
 * Pick a sensible default country. Prefers India (the app's launch
 * market) so the picker doesn't trick a VIT student into an "+1"
 * mistake on the most common entry path.
 */
